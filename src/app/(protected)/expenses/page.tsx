...
import TopExpensesCard from '@/components/charts/TopExpensesCard';
        ...
        >
            ...
            >
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    >
                        <TrendChart
                            key={`expense-trend-chart-${refreshKey}-${dateRange.startDate.getTime()}-${dateRange.endDate.getTime()}`}
                    ...
                    >
                        <BreakdownChart
                            key={`expense-breakdown-chart-${refreshKey}-${dateRange.startDate.getTime()}-${dateRange.endDate.getTime()}`}
                            startDate={formatDateForIST(dateRange.startDate)}
                            endDate={formatDateForIST(dateRange.endDate)}
                            expenseOnly={true}
                        />
                ...
                >
                    <TopExpensesCard
                        key={`top-expenses-${refreshKey}-${dateRange.startDate.getTime()}-${dateRange.endDate.getTime()}`}
                        startDate={formatDateForIST(dateRange.startDate)}
                        endDate={formatDateForIST(dateRange.endDate)}
                    />
                </motion.div>
            ...
            >
                <ExpenseHeatmap
                    key={`expense-heatmap-${refreshKey}-${dateRange.startDate.getTime()}-${dateRange.endDate.getTime()}`}
                    startDate={formatDateForIST(dateRange.startDate)}
                    endDate={formatDateForIST(dateRange.endDate)}
                />
            </motion.div>
